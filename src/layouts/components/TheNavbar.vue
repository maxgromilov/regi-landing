    ...
    <vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
      ...
      <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
        ...
        <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
          ...
          <vs-dropdown-item @click="updateLocale('et')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/et.png" alt="et" /> &nbsp;Estonian</vs-dropdown-item>
        </vs-dropdown-menu>
      </vs-dropdown>
...
export default {
    ...
    computed: {
        ...
        getCurrentLocaleData() {
            ...
            else if (locale == "et") return { flag: "et", lang: 'Estonian' }
